...
const inpAddUrl = document.querySelector(".inputUrl");
const inpAddName = document.querySelector(".inputName");
const inpAddSur = document.querySelector(".inputSurname");
const inpAddNumb = document.querySelector(".inputNumber");
const inpAddEmg = document.querySelector(".inputEmail");
...
async function getData() {
    try {
        let result = await fetch(`${API}?q=${searchValue}`);
